...
import cc.seedland.foundation.net.callback.DownloadProgressCallBack;
...
public class DownloadSubscriber<ResponseBody extends okhttp3.ResponseBody> extends BaseSubscriber<ResponseBody> {
    ...
    public void onError(final ApiException e) {
        LogUtils.INSTANCE.d("DownSubscriber:>>>> onError:" + e.getMessage());
        finalonError(e);
    }

    @Override
    public void onNext(ResponseBody responseBody) {
        LogUtils.INSTANCE.d("DownSubscriber:>>>> onNext");
    ...
    private boolean writeResponseBodyToDisk(String path, String name, Context context, okhttp3.ResponseBody body) {
        LogUtils.INSTANCE.d("contentType:>>>>" + body.contentType().toString());
        ...
        try {
           ...
           /* if (!futureStudioIconFile.exists()) {
            ...
            try {
                ...
                LogUtils.INSTANCE.d("file length: " + fileSize);
                ...
                while (true) {
                    ...
                    LogUtils.INSTANCE.d("file download: " + fileSizeDownloaded + " of " + fileSize);
                    //下载进度
                ...
                outputStream.flush();
                LogUtils.INSTANCE.d("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                ...
                if (callBack != null) {
                    ...
                    LogUtils.INSTANCE.d("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                    LogUtils.INSTANCE.d("file downloaded: is sucess");
                }
