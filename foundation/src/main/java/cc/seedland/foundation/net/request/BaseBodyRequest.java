...
import cc.seedland.foundation.net.callback.ProgressResponseCallBack;
import cc.seedland.foundation.net.RequestBodyUtils;
...
public abstract class BaseBodyRequest<R extends BaseBodyRequest> extends BaseRequest<R> {
    ...
    public R upString(String string, String mediaType) {
        this.string = string;
        CommonUtils.checkNotNull(mediaType, "mediaType==null");
    ...
    private MultipartBody.Part addFile(String key, HttpParams.FileWrapper fileWrapper) {
        ...
        RequestBody requestBody = getRequestBody(fileWrapper);
        CommonUtils.checkNotNull(requestBody, "requestBody==null fileWrapper.file must is File/InputStream/byte[]");
