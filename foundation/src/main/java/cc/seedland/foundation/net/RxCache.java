...
import cc.seedland.foundation.net.cache.CacheCore;
import cc.seedland.foundation.net.cache.LruDiskCache;
...
import cc.seedland.foundation.net.stategy.IStrategy;
...
public final class RxCache {
    ...
    public <T> ObservableTransformer<T, CacheResult<T>> transformer(CacheMode cacheMode, final Type type) {
        ...
        return (@NonNull Observable<T> upstream) -> {
            LogUtils.INSTANCE.d("cacheKey = " + RxCache.this.cacheKey);
            Type tempType = type;
            if (type instanceof ParameterizedType) {//自定义ApiResult
                ...
                if (CacheResult.class.isAssignableFrom(cls)) {
                    tempType = CommonUtils.getParameterizedType(type, 0);
                }
            }
    ...
    public static final class Builder {
        ...
        public RxCache build() {
            ...
            CommonUtils.checkNotNull(this.diskDir, "diskDir can't be null");
